...
def move_tiles(window,tiles,clock,direction):
    ...
    if direction == "left":
        ...
        reverse = True
        delta = (MOVE_VEL, 0)
        boundry_check = lambda tile: tile.col == COLS - 1
        get_next_tile = lambda tile: tiles.get(f"{tile.row}{tile.col + 1}")
        merge_check = lambda tile,next_tile: tile.x + RECT_WIDTH + MOVE_VEL < next_tile.x 
        ...
        get_next_tile = lambda tile: tiles.get(f"{tile.row}{tile.col}")
        ...
        move_check = (lambda tile, next_tile: tile.y < next_tile.y + RECT_HEIGHT + MOVE_VEL < next_tile.y)
        ceil = False           
